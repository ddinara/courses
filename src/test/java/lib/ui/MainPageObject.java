...
public class MainPageObject {
    ...
    public boolean waitForElementNotPesent(String locator, String error_message, long timeoutInSeconds)
    {
        By by = this.getLocatorByString(locator);
        WebDriverWait wait = new WebDriverWait(driver, timeoutInSeconds);
        wait.withMessage(error_message + "\n");
    ...
    public WebElement checkElementPresent(String locator, String error_message, long timeoutInSeconds)
    {
        WebElement element = waitForElementPresent(locator, error_message,timeoutInSeconds);
        return element;
    }
    ...
    public void scrollWebPageElementNotVisible(String locator, String error_message, int max_swipes){
    ...
    public void swipeUpToFindElement(String locator, String error_message, int max_swipes)
    {
        ...
        while(driver.findElements(by).size() == 0){
            ...
            if (already_swiped > max_swipes){
                waitForElementNotPesent(locator,"Cannot find element by swiping up. \n" + error_message, 0);
                return;
            }
    ...
    public int getTitlePresent(String locator)
    {
        By by = this.getLocatorByString(locator);
    ...
    {
        int title_present = getTitlePresent(locator);
        if (title_present == 0) {
            String defaultMessage = "Can find title element, '" + locator + "'present";
    ...
    {
        String[] exloded_locator = locator_with_type.split(Pattern.quote(":"),2);
        String by_type = exloded_locator[0];
        String locator = exloded_locator[1];
