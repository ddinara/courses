...
public class MainPageObject {
    ...
    public boolean waitForElementNotPesent(By by, String error_message, long timeoutInSeconds)
    {
        WebDriverWait wait = new WebDriverWait(driver, timeoutInSeconds);
        wait.withMessage(error_message + "\n");
        return wait.until(
    ...
    public WebElement checkElementPresent(By by, String error_message, long timeoutInSeconds)
    {
        WebElement element = waitForElementPresent(by, error_message,timeoutInSeconds);
        return element;
    }
    ...
    public int getTitlePresent(By by)
    {
