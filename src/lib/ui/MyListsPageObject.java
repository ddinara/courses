...
public class MyListsPageObject extends MainPageObject {
    ...
    public void openFolderByName(String name_of_folder)
    {
        ...
        this.waitForElementPresent(By.xpath(folder_name_xpath),
    ...
    {
        String article_xpath = getFolderXpathByName(article_title);
        this.waitForElementNotPesent(By.xpath(article_xpath),"Saved article still present with title" + article_title,15);
    }
