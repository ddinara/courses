...
public class SearchPageObject extends MainPageObject {
    ...
    {
        this.waitForElementNotPesent(By.id(SEARCH_CANCEL_BUTTON),"Search cancel button is still present!",5);
    }
    ...
    public int getSearchResults()
    {
        ...
        return this.getAmountOfElements(By.xpath(SEARCH_RESULT_LIST));
    }
